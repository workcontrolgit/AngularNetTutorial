...
# Script to sync master/main branch to develop branch in all submodules (auto-push version)
# Usage: bash sync-master-to-develop-auto.sh

set -e  # Exit on error

echo "========================================="
echo "Syncing master/main to develop in all submodules (AUTO-PUSH)"
echo "========================================="
echo ""
